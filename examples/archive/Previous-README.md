...
![A low flight across the Ultra Desert](v1.4/ultra-desert.png)

*Across the Ultra Desert. A newly retaken, unretouched capture from the current build; [open this scene](v1.4/ultra-desert.json) in the app to explore it.*

Download the [v1.4.0 release](https://github.com/JoeCauley/sphere-observatory/releases/tag/v1.4.0). See [release notes](../../docs/releases/v1.4.0.md), the [new screenshot gallery](v1.4/) and the [next development plan](../../docs/Observatory-Next-Leap.md).
...
![Clouds above the layered edge of a Wound, opening into space](v1.4/wound-edge.png)

*At the edge of a world: local clouds, exposed shell strata and the open breach.*

| The broken Shade | Walking the Mycelium Sea |
|---|---|
| ![Textured Shade skin with exposed structural ribs](v1.4/shade-structure.png) | ![A walking field site beneath the curved inner shell](v1.4/mycelium.png) |

The [full gallery](v1.4/) also includes a cloud sea and exterior wreckage. Every image has an importable scene file; these are renderer captures, with no compositing or retouching.
...
![Ultra Desert at one kilometre](hero-review/attempt3/ultra-desert-grazing.png)

[Before/after screenshots](hero-review/) · [Performance and implementation](../../docs/Observatory-Hero-Textures-10.md) · [Independent visual review](../../docs/texture-critic-review.md)
...
![A trimmed shade and its shadow](shade-eclipse.png)

These images come from the renderer. Import companion JSON files from [examples]() using **Capture → Import scene**.
