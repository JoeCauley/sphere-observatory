...
![The stellar-scale interior of The Sphere](observatory/interior.jpg)

*The stellar conservatory: a close view of the central star and its damaged service rings, with the far shell behind them. [Restore this viewpoint](observatory/interior.json).*
...
- **Walking ground keeps its own biome.** Corrected the shared green-brown
  border on snow, desert and machinery patches. Existing saved patches and
  connected terrain now receive the same biome and era settings as the shell.
  [Material correction](../../../docs/Observatory-Ground-Material-01.md).
- **Three connected Watershed compositions.** Visit the receiving lake, quiet
  reach and open meadow through **Explore → Places → Watersheds**, or inspect
  their regional views with Landscape view. New regional materials share the
  existing water and ground; saved scenes retain their chosen art revision. Local
  shore planting and structures are the next step. [Design and bounds](../../../docs/Observatory-Watershed-Trio-01.md).
...
![A wide view across the shell, its habitat waist and Shade fleet](observatory/cavity.jpg)

*Across the interior: distant Shades, enormous Wounds and the habitat waist. [Scene and 4K photograph](observatory/README.md#across-the-interior).*
...
![Clouds and surviving ground at a Wound](observatory/wound.jpg)

*A Wound turns the edge of the landscape into the edge of the world. [Scene](observatory/wound.json).*
...
![The Watershed river garden](observatory/river-garden.jpg)

*The same project that models an astronomical-unit shell also makes room for a river garden. [Scene](observatory/river-garden.json).*
...
|---|---|
| ![A broken Shade and its structural detail](observatory/shade.jpg) | ![Clouds within the Sphere](observatory/clouds.jpg) |

**[Explore the new gallery and its saved scenes](../../observatory)** · [Previous photographs and README](../README.md)
