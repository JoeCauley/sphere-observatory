...
After starting Observatory, open `/examples/archive/hero-review/index.html` in your browser for the complete comparison. The HTML and PNGs also work locally without the rendering app.

![Ultra Desert at 1 km](attempt3/ultra-desert-grazing.png)
