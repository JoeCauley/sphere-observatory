...
[Portable before/after gallery](../examples/archive/hero-review/index.html) collects matched 1 km screenshots. The remote atlas is an illustrative region design, not geographically matched hero terrain; its broad colour changes and region boundaries remain visible in far-away comparisons. The low-altitude scores do not certify those remote transitions as seamless.
