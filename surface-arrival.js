...
function inspection(s,near,kind){
 ...
 return {position,forward:M.norm(M.sub(target,position)),up:M.mul(q,-1),siteId:'rim',siteAnchor:f.point,geometryDetail:true,fov:s.fov,speed:wide?.2:.05,exposure:s.exposure};
}
function spill(s,selected){
 ...
 return {position,forward:M.norm(M.sub(target,position)),up:basis[1],siteId:'exterior-0',siteAnchor:selected,geometryDetail:true,wreckage:true,spaceEnvironment:0,fov:s.fov,speed:10,exposure:s.exposure};
}
...
function atPoint(s,selected,{aspect=16/9}={}){
 ...
 const state={...s,siteId:'',siteAnchor:null,siteRevision:0,siteElevation:0,walkSurface:false,walkMode:false,walkPosition:null,shadeAttachment:null,projection:'perspective'};
